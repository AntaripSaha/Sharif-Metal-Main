        ...
        <div class="card-body" id="ledger_view">
            ...
            ?>
                    ...
                    <tr style="margin-top:5px;">
                        ...
                        <td style="text-align: center; width: 25px;padding: 5px ;">{{number_format($product->unit_price, 2)}}</td>
                        <td style="text-align: center; width: 25px;padding: 5px ;">{{number_format($product->del_qnt * $product->unit_price, 2)}}
