    ...
    <div class="container">
        ...
        <div>
            <div >
                ...
                <div class="col-md-12">
                    ...
                    <span style="font-size: 18px; text-align: left;float: left; width: 30%">Bill No :
                    @php 
                    $str = $chalan->req_id;
        ...
        <div class="card-body" id="ledger_view">
            <table id="print_code" style="width: 940px;">
                <thead>
                <tr>
                        <th style="width:10px; text-align:center; font-size:18px !important;">SL.No</th>
                        <th style="width:30px; text-align:center; font-size:18px !important;">Products Code</th>
                        <th style="width:350px; text-align:center; font-size:18px !important;">Product Name</th>
                        <th style="width:10px; text-align:center; font-size:18px !important;">Head</th>
                        <th style="width:20px; text-align:center; font-size:18px !important;">QTY</th>
                        <th style="width:25px; text-align:center; font-size:18px !important;">Unit Price</th>
                        <th style="width:25px; text-align:center; font-size:18px !important;">Amount</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    <tr style="margin-top:5px;">
                        <td style="text-align: center; font-weight: 650; width: 20px; height: 29px;font-size:18px!important;">{{$loop->index + 1}}</td>
                        ...
                        <td style="text-align: center; width: 20px;font-size:18px!important;">
                        ...
                        <td style="text-align: center; width: 20px;font-size:18px!important;">{{$product->del_qnt}}</td>
                        <td style="text-align: center; width: 20px;font-size:18px!important;">{{number_format($product->unit_price, 2)}}</td>
                        <td style="text-align: center; width: 15px;font-size:18px!important;">{{number_format($product->del_qnt * $product->unit_price, 2)}}
                ...
                <tfoot>
                    <tr>
                        <td class="text-left" colspan="3" rowspan="4"><b style="font-size: 18px;">Taka(In
                                Words):</b><span style="font-size: 18px; margin-top: 0px;"> {{$amount}} </span></td>
                        <td colspan="2" style="padding: 5px;"><b style="font-size: 18px;">Total(Tk.)</b></td>
                        <td style="text-align: right;" colspan="2"><span
                                style="margin-right: 13%;">=<?php echo (number_format($sum_total, 2 , '.', ',')) ?>/=</span></td>
                    </tr>

                    <tr>
                        <td colspan="2" style="padding: 5px;"><b style="font-size: 18px;">Discount(%)</b></td>
                    ...
                    <tr>
                        <td colspan="2" style="padding: 5px;"><b style="font-size: 18px;">Discount Amt.</b></td>
                        <td style="text-align: right;" colspan="2"><span
                                style="margin-right: 13%;">({{ number_format((int)$chalan->del_discount, 2)}})</span></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="padding: 5px;"><b style="font-size: 18px;">Grand Total</b></td>
                        <td style="text-align: right;" colspan="2"><span
