...
<body style="margin: 20%; margin-top:2%; margin-bottom:0%;">
    <div class="container">
        <div class="row">
        <div class="card">
        <div >
        ...
        <div class="card-body" id="ledger_view">
            <table id="print_code" style="width: 930px;">
                <thead>
                <tr style="width:450px">
                        <th style="width:20px">SL.No</th>
                        <th style="width:20px !important;">Products Code</th>
                        <th style="width:350px !important;">Product Name</th>
                        <th style="width:20px">Head</th>
                        <th style="width:20px">QTY</th>
                        <th style="width:25px !important;">Unit Price</th>
                        <th style="width:25px !important;">Amount</th>
                    </tr>
                </thead>
            ...
            ?>
                    ...
                    <tr style="margin-top:5px;">
                        ...
                        <td style="text-align: center; width: 20px;">{{number_format($product->unit_price, 2)}}</td>
                        <td style="text-align: center; width: 15px;">{{number_format($product->del_qnt * $product->unit_price, 2)}}
