                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input readonly class="form-control form-control-sm rate" type="text"
                                                    name="unit_price[]" id="" value="{{ $product->unit_price }}">
                                                <input class="form-control form-control-sm rate" type="hidden"
                                                    name="production_price[]" id="" value="{{ $product->production_price }}">
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                @php
                                                $prod_new_price = $product->qnty * $product->unit_price;
                                                @endphp

                                                @else
                                                {{-- <?php $prd_disc = $product->qnty * $product->unit_price*($product->prod_disc/100) ?> --}}
                                                @php
                                                $prod_new_price = ($product->qnty * $product->unit_price) -
                                                ((($product->qnty *
                                                $product->unit_price) * $product->prod_disc) / 100);
                                                @endphp
                                                ...
                                                <input readonly class="form-control form-control-sm product_price"
                                                    type="text" name=""
                                                    value="{{ $product->qnty *  $product->unit_price }}">
                                            </td>
                                            </td>
                                            <td>
