...
class SellerController extends BaseController
{
    ...
    {    
        ...
        if ($request->ajax()) {
            return Datatables::of($data)
                    ...
                    if($this->user->isOfficeAdmin()){
                        ...
                        $btn = $btn_printChalan.$btn_print.$btn_view.$btn_reject;
                    }
                    //role id 19 = Bill
        ...
        return view('seller::manage_sales');
    }
    ...
    public function child_users_requisition(Request $request){
        ...
        return view('seller::child_sell_requisition');
    }
