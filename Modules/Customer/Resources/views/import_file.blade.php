...
<form method="POST" action="{{ route('customer.import_file') }}" enctype="multipart/form-data">
    ...
    <div class="modal-header">
        <h5 class="modal-title">@lang('customer.new_customer_import')</h5>
    ...
    <div class="modal-body">
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-12 row pt-3">
                ...
                <div class="col-lg-6">
                    <a href="" ><button type="button" class="btn btn-success float-right " >@lang('layout.download_demo')</button></a>
                </div>
            </div>
        </div>
    </div>
