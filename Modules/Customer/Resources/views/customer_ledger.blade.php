...
<section class="content" id="ajaxview">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">@lang('customer.customer_ledgers')</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">@lang('customer.customer_ledgers')</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header card_buttons">
                        <h3 class="card-title">@lang('customer.customer_ledgers')</h3>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header card_buttons row">
                        <h3 class="card-title col-sm-10">Customer ledger</h3> 
                        {{-- <button class="btn btn-sm btn-info col-sm-2" id="ledger_all">All Ledgers</button> --}}
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body" id="ledger_view">
                        <table id="ledgersTable" class="table table-sm table-bordered table-striped display responsive nowrap"
                            width="100%">
                            <thead>
                                <tr>
                            ...
                            <tbody >
                                ...
                                <tr>
                                    ...
                                    <td style="width: 25%;">{{$transaction->Narration}}</td>
...
@endsection
@section('js')
<script src="{{asset('js/Modules/Customer/ledgers.js')}}"></script>
@endsection
