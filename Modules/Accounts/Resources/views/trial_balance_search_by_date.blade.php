                ...
                <div class="col-12">
                    <div class="card">
                        <form method="get" action="{{ route('accounts.trail_balance_by_date') }}">
                            ...
                            <div class="card-header card_buttons row">
                                ...
                                <div class="form-inline card_buttons col-8">
                                    ...
                                    <input type="date" class="form-control mr-sm-2 form-control-sm" id="from" name="from" value="{{ $from  }}">
                                    <label for="to" class="mr-2">@lang('layout.to') : </label>
                                    <input type="date" class="form-control mr-sm-2 form-control-sm" id="to" name="to" value="{{ $to  }}">
                        ...
                        <div id="ledger_view">
                            ...
                            <div class="card-body" >
                                <div class="col-md-12">
                                    <h5 class="text-center" id="gl_title">Trial Balance on [{{ $from }} TO {{ $to  }}]</h5>
                                </div>
                                <table id="ledgersTable" class="table table-bordered table-striped table-sm responsive nowrap"
                                    ...
                                    @foreach($accounts as $account)
                                        ...
                                        @if(count($account->childrenRecursive))
                                                    @include('accounts::trial_partial_search_by_date',
                                                    [
    ...
    <script>
        ...
        function printPdf() {
            ...
            var opt = {
                ...
                filename: 'TrialBalance['+fromDate+' To '+toDate+'].pdf',
                image: {
                    type: 'jpeg',
                    quality: 0.98
                },
