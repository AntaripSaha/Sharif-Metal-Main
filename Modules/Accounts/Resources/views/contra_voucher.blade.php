...
<section class="content" id="ajaxview">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">@lang('account.contra_voucher')</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">@lang('account.contra_voucher')</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header card_buttons">
                        <h3 class="card-title">@lang('account.contra_voucher')</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        {!!Form::open(['route'=>'accounts.contra_voucher','id'=>'contra_voucher-add-form']) !!}
                        ...
                        <div class="form-group row">
                            <div class="col-lg-4">
                                <label>@lang('account.trans_from')<i class="text-danger"> *</i></label>
                        ...
                        <div class="form-group row">
                            <label for="pay_from" class="col-sm-2 col-form-label">@lang('account.trans_to')<i class="text-danger">*</i></label>
                            <div class="col-sm-4">
                                <select class="custom-select" id="payment_from" name="payment_from">
                                    @foreach($trans as $tran)
                                        <option value="{{$tran->HeadCode}}">{{$tran->HeadName}} - {{$tran->HeadCode}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
$('.receive').on('click', '#add_receive', function(){
    ...
    var confirmtext = ' Insert Contra Voucher';
    var confirmCallback=function(){
        var form=$('#contra_voucher-add-form');
        var successcallback=function(a){
            toastr.success('Contra Voucher Added Successfylly !!');
            location.reload();
        }
