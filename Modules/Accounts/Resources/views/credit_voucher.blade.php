            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-lg-4">
                                <label>@lang('account.rec_frm')<i class="text-danger"> *</i></label>
                        ...
                        <div class="form-group row">
                            <label for="pay_from" class="col-sm-2 col-form-label">@lang('account.rec_at')<i class="text-danger">*</i></label>
                            <div class="col-sm-4">
