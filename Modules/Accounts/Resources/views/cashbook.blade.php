...
<section class="content" id="ajaxview">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">@lang('account.cash_book')</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">@lang('account.cash_book')</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                            ...
                            <div class="row" style="width: 100%">
                                <div class="col-md-4 mb-2">
                                    ...
                                    <select class="form-control" id="cash_type" onchange="cashType()">
                                        <option selected disabled>Please Select Cash Type</option>
...
<script type="text/javascript">
    ...
    function cashType() {
        ...
        $.ajax({
            type: 'GET',
            url: "{{route('account.CashBookFilter')}}",
            data: {
                HeadCode: HeadCode
            },
            success: function (data) {
                ...
                let total_balance = 0;
                $("#gl_title").html(`
                        CashBook of ( ${data.head_name} - ${data.HeadCode} ) - ( All )
                        `);
            ...
            if (!from && !to) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        let total_balance = 0;
                        $("#gl_title").html(`
                        CashBook of ( ${data.head_name} - ${data.HeadCode} ) - (On ${data.from} To ${data.to} )
                        `);
                        $.each(data.cash_books, (key, value) => {
